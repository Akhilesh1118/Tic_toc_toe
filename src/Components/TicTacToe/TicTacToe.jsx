...
let data = ["", "", "", "", "", "", "", "", ""];
 ...
 const TicTacToe = () => {
    ...
    let boxs_array = [box1,box2,box3,box4,box5,box6,box7,box8,box9];
    ...
    const toggle = (e,num) => {
        ...
        if(count % 2 === 0) {
         ...
         const won = (winner) => {
            setLock(true);
            if(winner==="x") {
                titleRef.current.innerHTML = `congratulation: Won!  <img src=${cross_icon} />`;
            }else{
                titleRef.current.innerHTML = `congratulation: Won!  <img src=${circle_icon} />`;
            }
        }
